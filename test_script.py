...
if __name__ == "__main__":
    ...
    #model = CrinaSynapse(vocab_size=65, d_model=256, n_layers=8).to(device)
    ...
    #dummy_text = torch.ones(1, 128).to(device)  # [1, 128]
    ...
    #flops, params = profile(model, inputs=[dummy_text.to(dtype=torch.long)], verbose=False)
